...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in delivery_pb2_grpc.py depends on'
...
class DeliveryServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.CreateDelivery = channel.unary_unary(
                ...
                request_serializer=delivery__pb2.CreateDeliveryRequest.SerializeToString,
                response_deserializer=delivery__pb2.CreateDeliveryResponse.FromString,
        ...
        self.UpdateDeliveryStatus = channel.unary_unary(
                ...
                request_serializer=delivery__pb2.UpdateDeliveryStatusRequest.SerializeToString,
                response_deserializer=delivery__pb2.UpdateDeliveryStatusResponse.FromString,
                _registered_method=True)
...
def add_DeliveryServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CreateDelivery': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=delivery__pb2.CreateDeliveryRequest.FromString,
                    response_serializer=delivery__pb2.CreateDeliveryResponse.SerializeToString,
            ),
            ...
            'UpdateDeliveryStatus': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=delivery__pb2.UpdateDeliveryStatusRequest.FromString,
                    response_serializer=delivery__pb2.UpdateDeliveryStatusResponse.SerializeToString,
            ),
    }
...
class DeliveryService:
    ...
    def CreateDelivery(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/delivery.DeliveryService/CreateDelivery',
            delivery__pb2.CreateDeliveryRequest.SerializeToString,
            delivery__pb2.CreateDeliveryResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def UpdateDeliveryStatus(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/delivery.DeliveryService/UpdateDeliveryStatus',
            delivery__pb2.UpdateDeliveryStatusRequest.SerializeToString,
            delivery__pb2.UpdateDeliveryStatusResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
